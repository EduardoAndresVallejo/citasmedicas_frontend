...
const ConfirmarCuentaDoctor = () => {
    ...
    <div className='max-w-md w-full relative z-10 p-5'>
        ...
        <div className='text-center mb-10 mt-10 md:mt-0'>
            ...
            <p className='text-lg text-green-400 mt-2 font-medium'>Comienza a Visualizar tus Citas</p>
        </div>
            ...
            {cuentaConfirmada &&
                <nav className='mt-8 flex justify-center'>
                    <Link
                        ...
                        to="/doctor"><span className='font-bold'>Inicia Sesión</span>
                    </Link>
                </nav>}
        </div>
...
export default ConfirmarCuentaDoctor;
